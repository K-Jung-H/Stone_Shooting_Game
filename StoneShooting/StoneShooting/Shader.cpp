...
void CTexturedShader::Setting_Render(ID3D12GraphicsCommandList* pd3dCommandList, Object_Type o_type, Item_Type i_type)
{
	CShader::Setting_PSO(pd3dCommandList, 0);
}
...
Textured_UI_Shader::Textured_UI_Shader()
{
}
...
D3D12_INPUT_LAYOUT_DESC Textured_UI_Shader::CreateInputLayout()
{
	D3D12_INPUT_LAYOUT_DESC d3dInputLayoutDesc;
	d3dInputLayoutDesc.pInputElementDescs = NULL;
	d3dInputLayoutDesc.NumElements = 0;
...
D3D12_SHADER_BYTECODE Textured_UI_Shader::CreateVertexShader(ID3DBlob** ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Textured_UI.hlsl", "VSTextured_UI", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE Textured_UI_Shader::CreatePixelShader(ID3DBlob** ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Textured_UI.hlsl", "PSTextured_UI", "ps_5_1", ppd3dShaderBlob));
}

void Textured_UI_Shader::CreateShader(ID3D12Device* pd3dDevice, ID3D12RootSignature* pd3dGraphicsRootSignature)
{
	m_nPipelineStates = 2;
	m_ppd3dPipelineStates = new ID3D12PipelineState * [m_nPipelineStates];
